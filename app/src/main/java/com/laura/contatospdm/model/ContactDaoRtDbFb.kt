...
class ContactDaoRtDbFb: ContactDao {
    ...
    private val contactRtDbFbReference = Firebase.database
        .getReference(CONTACT_LIST_ROOT_NODE)
        ...
        contactRtDbFbReference.addChildEventListener(object: ChildEventListener {
            ...
            override fun onChildChanged(snapshot: DataSnapshot, previousChildName: String?) {
                ...
                contact?.also { editedContact ->
                    contactList.indexOfFirst { editedContact.id == it.id }.also {
                        contactList[it] = editedContact
                    }
